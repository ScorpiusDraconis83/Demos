...
| `<install>` element demo | Demo that showcases the use of the `<install>` HTML element to declaratively install web apps. | [/pwa-install-element/](https://github.com/MicrosoftEdge/Demos/tree/main/pwa-install-element/) | [The `<install>` Element Store](https://microsoftedge.github.io/Demos/pwa-install-element/) |
| Install API demo | A PWA that uses the Web Install API to install other PWAs. | [/pwa-install-api/](https://github.com/MicrosoftEdge/Demos/tree/main/pwa-install-api/) | [Edge demos](https://microsoftedge.github.io/Demos/pwa-install-api/) |
